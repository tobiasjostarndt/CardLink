 ...
 public class SecureMessaging {
     ...
     public CommandApdu encrypt(final ICommandApdu commandApdu) throws IOException {
         ...
         if (commandApdu.getNe() != null) {
             ...
             this.le = CommandApdu.EXPECTED_LENGTH_WILDCARD_EXTENDED;
         }
     ...
     private void checkResponseApduSize(final byte[] responseApduBytes) {
         if (responseApduBytes.length < MIN_RESPONSE_SIZE) {
             com.appdinx.cardlink.CardLink.error = "couldNotInitializeSession";
             throw new IllegalArgumentException("Malformed Secure Messaging APDU. "+ DatatypeConverter.printHexBinary(responseApduBytes));
         }
     }
